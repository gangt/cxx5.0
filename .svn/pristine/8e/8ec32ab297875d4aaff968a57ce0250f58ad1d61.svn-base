package com.xi6666.libray.widget;
...
public class HeaderViewPager extends LinearLayout {
    ...
    private boolean mScrolled = true;         //是否可以滚动
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        maxY = mScrolled ? mHeadHeight - topOffset : 0;
        //让测量高度加上头部的高度
    ...
    public void setScrolled(boolean bol) {
        this.mScrolled = bol;
        maxY = 0;
    }
    ...
    public void setVerticalScrollFlag(boolean verticalScrollFlag) {
        this.verticalScrollFlag = verticalScrollFlag;
    }
