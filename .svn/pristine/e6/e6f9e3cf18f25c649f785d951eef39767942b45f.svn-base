...
import com.xi6666.car.view.custom.WheelPicker;
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        for (int j = 0; j < secondTexts.size(); j++) {
            ...
            if (st.contains(secondText)) {
                ...
                LogUtil.d("TAG","init select second text: " + st);
                break;
            }
        }
        ...
        for (int k = 0; k < thirdTexts.size(); k++) {
            ...
            if (tt.contains(thirdText)) {
                ...
                LogUtil.d("TAG","init select third text: " + tt);
                break;
            }
        }
        LogUtil.d("TAG",String.format("init select index: %s-%s-%s", selectedFirstIndex, selectedSecondIndex, selectedThirdIndex));
    }
