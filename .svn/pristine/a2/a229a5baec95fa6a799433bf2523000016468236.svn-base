 ...
 *   View view = findViewById(R.id.view);
     ...
     badge.show();
 */
public class RedNumberRadioView extends TextView {
    ...
    public RedNumberRadioView(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public RedNumberRadioView(Context context, AttributeSet attrs) {
     ...
     */
    public RedNumberRadioView(Context context, View target) {
     ...
     */
    public RedNumberRadioView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public RedNumberRadioView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public RedNumberRadioView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
