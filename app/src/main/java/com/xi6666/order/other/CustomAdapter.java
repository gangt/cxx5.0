...
public abstract class CustomAdapter<T> extends RecyclerView.Adapter<CustomViewHolder> {
     ...
     * @param itemLayoutId
     */
    protected CustomAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    private void onBindAdvanceViewHolder(CustomViewHolder holder, int i) {
     ...
     */
    public abstract void convert(CustomViewHolder holder, T item);
     ...
     * @return Holder对象
     */
    protected CustomViewHolder onCreateAdvanceViewHolder(ViewGroup parent, int viewType) {
    ...
    class HeaderHolder extends CustomViewHolder {
    ...
    class FooterHolder extends CustomViewHolder {
