...
public class NormalAlertDialog implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            titleText = "温馨提示";
            titleTextColor = ContextCompat.getColor(mContext, R.color.black_text);

            contentText = "";
            contentTextColor = ContextCompat.getColor(mContext, R.color.black_text);
            isSingleMode = false;
            singleButtonText = "确定";
            singleButtonTextColor = ContextCompat.getColor(mContext, R.color.black_text);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.black_text);
            rightButtonText = "确定";
            rightButtonTextColor = ContextCompat.getColor(mContext, R.color.black_text);
