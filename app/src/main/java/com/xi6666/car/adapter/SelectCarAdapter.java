...
public class SelectCarAdapter extends BaseExpandableListAdapter {
     ...
     * 即将要展示的数据
     */
    private List<SelectCarBean.DataBean.CharBean> mStrData;
    /**
     *
     */
    ...
    public SelectCarAdapter(Context context,List<SelectCarBean.DataBean.CharBean> data){
        super();
    ...
    private void sort(){
         ...
         * 便利所有数据
         */
        for(SelectCarBean.DataBean.CharBean bean : mStrData){
    ...
    private HashList<String, SelectCarBean.DataBean.CharBean> mLetter = new HashList<>(new KeySort<String, SelectCarBean.DataBean.CharBean>() {
        public String getKey(SelectCarBean.DataBean.CharBean selectCarBean) {
            return AssortPinyinList.getFirstChar(selectCarBean.brand_char);
        }
    });
    ...
    public HashList<String,SelectCarBean.DataBean.CharBean> getAssortList() {
        return mLetter;
    }
     ...
     * 比较中文顺序
     */
    class CitySortComparator implements Comparator<SelectCarBean.DataBean.CharBean> {

        @Override
        public int compare(SelectCarBean.DataBean.CharBean lhs, SelectCarBean.DataBean.CharBean rhs) {
    ...
    public interface OnItemClickListener{
        void onItemClick(SelectCarBean.DataBean.CharBean data);
    }
}
