...
import com.xi6666.network.cookie.cache.CookieCache;
import com.xi6666.network.cookie.persistence.CookiePersistor;
...
public class PersistentCookieJar implements ClearableCookieJar {
    ...
    synchronized public List<Cookie> loadForRequest(HttpUrl url) {
        ...
        Log.d(TAG, "validCookies.toString--->" + validCookies);
