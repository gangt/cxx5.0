...
public class BrandDetailsAdapter extends RecyclerView.Adapter {
    ...
    private OnBrandDetailsClickListener mOnBrandDetailsClickListener;


    public BrandDetailsAdapter(Context mContext) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MallHomeAdapter.MallHomeViewHolder) {
            homeViewHolder((MallHomeAdapter.MallHomeViewHolder) holder, position);
        }
    }

    private void homeViewHolder(MallHomeAdapter.MallHomeViewHolder holder, int position) {
        //数据
...
//        holder.mNumberTv.setText(data.getBuynumber() + "人购买");
     ...
     * @param listener
     */
    public void setOnMallHomeClickListener(OnBrandDetailsClickListener listener) {
        this.mOnBrandDetailsClickListener = listener;
    }

    public void update(List<BrandDetailsBean.DataBean.ListBean> list) {
        mDatas.clear();
        addData(list);
    }
        ...
        public MallHomeViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnBrandDetailsClickListener != null) {
                        mOnBrandDetailsClickListener.onItemClickBrandDetails(mDatas.get(getPosition()));
                    }
                }
            });
        }
     ...
     * 接口
     */
    public interface OnBrandDetailsClickListener {
        void onItemClickBrandDetails(BrandDetailsBean.DataBean.ListBean bean);
    }
}
