...
public class AddOilDataBean {
    ...
    public static class DataBean {
        ...
        public String getPackage_show() {
            return package_show;
        }

        public void setPackage_show(String package_show) {
            this.package_show = package_show;
        }
