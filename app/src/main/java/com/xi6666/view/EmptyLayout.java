...
/**
 * Created by Mr_yang on 2016/10/25.
 */
...
public class EmptyLayout extends FrameLayout {
    ...
    private String mErrorMessage = "网络数据错误,请重试";
    private String mEmptyMessage = "暂时没有相关数据";
            ...
            case TYPE_LOADING:
                ...
                if (mLoadingView != null) {
                    ...
                    if (mLoadingAnimation != null && loadingAnimationView != null) {
                        ...
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading1), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading2), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading3), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading4), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading5), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading6), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading7), 100);
                        animationDrawable.addFrame(mContext.getResources().getDrawable(R.drawable.loading8), 100);
                        loadingAnimationView.setBackgroundDrawable(animationDrawable);
